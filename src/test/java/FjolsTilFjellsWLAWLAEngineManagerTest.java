...
public class FjolsTilFjellsWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FjolsTilFjellsWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/FjolsTilFjellsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/FjolsTilFjellsWLAIW/InitOutcome.xml").getDocumentElement();
